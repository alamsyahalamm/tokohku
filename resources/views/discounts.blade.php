                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="p-4">Kategori Diskon</th>
                            <th scope="col" class="p-4">Produk</th>
                            <th scope="col" class="p-4">Diskon</th>
                            <th scope="col" class="p-4">Jangka Waktu</th>
                ...
                <form action="{{ route('discounts.store') }}" method="POST">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div class="relative">
                            ...
                            <input id="datepicker-range-start" name="start_date" autocomplete="off" datepicker
                        ...
                        <div class="relative">
                            ...
                            <input id="datepicker-range-end" name="end_date" autocomplete="off" datepicker
                                datepicker-buttons datepicker-autoselect-today type="text"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Berakhir" required>
                        </div>
                    </div>
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div>
                            <label for="category_discount_id"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Kategori
                            </label>
                            <select id="category_discount_id" name="category_discount_id"
                    ...
                    <div class="mb-4">
                        <label for="percentage" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Diskon
                        </label>
