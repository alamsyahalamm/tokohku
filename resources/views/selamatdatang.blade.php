...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    ...
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="https://flowbite.com/" class="hover:underline">tokohku™</a>.Alhamdulillah</span>
    </div>
</footer>
</body>
</html>
