                    ...
                    <tbody>
                        @forelse ($categories as $item)
                            ...
                            <div id="delete-modal-{{ $item->id }}" tabindex="-1"
                                ...
                                <form action="{{ route('discount_categories.destroy', $item->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-6 text-center">
                                                ...
                                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                                    Apakah anda yakin ingin menghapus kategori diskon ini?
                                                </h3>
    ...
    <div id="defaultModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <!-- Modal body -->
                <form action="{{ route('discount_categories.store') }}" method="POST">
                    @csrf
                    <div class="mb-4">
                        <div>
                            <label for="name"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Kategori Diskon</label>
